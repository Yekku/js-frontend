...
Такой обход дерева называется обход в глубину. Сначала мы опускаемся до самого дна самой левой ветки, затем ветки чуть правее и так далее пока не дойдем до конца.} list
 */
const hasZero = (list) => {
  if (isEmpty(list)) {
    return false;
...
/** ====================================================== 
 * Ниже код функции searchZeros, которая, в отличие от предыдущей реализации, возвращает число нулей в дереве:
*/
